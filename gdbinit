...
set $COLOR_REGVAL_MODIFIED  = $YELLOW
...
define regx64
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$cs")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$cs"))
else:
    sys.stdout.write(" ----  ")
	end
    color $COLOR_REGNAME
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$ds")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$ds"))
else:
    sys.stdout.write(" ----  ")
	end
    color $COLOR_REGNAME
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$es")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$es"))
else:
    sys.stdout.write(" ----  ")
	end
    color $COLOR_REGNAME
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$fs")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$fs"))
else:
    sys.stdout.write(" ----  ")
	end
    color $COLOR_REGNAME
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$gs")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$gs"))
else:
    sys.stdout.write(" ----  ")
	end
    color $COLOR_REGNAME
    ...
    color $COLOR_REGVAL
	python
if str(gdb.parse_and_eval("$ss")) != "<unavailable>":
    sys.stdout.write(" %04X  " % gdb.parse_and_eval("$ss"))
else:
    sys.stdout.write(" ----  ")
	end
    color_reset
...
define context
    ...
    if $SHOWSTACK == 1
       ...
       printf "[0x%08X]", $sp
		...
		python
if str(gdb.parse_and_eval("$ss")) != "<unavailable>":
    sys.stdout.write("[0x%04X:" % gdb.parse_and_eval("$ss"))
else:
    sys.stdout.write("[0x----:")
sys.stdout.write("0x%016lX]" % gdb.parse_and_eval("$rsp"))
		end
        else
			python
if str(gdb.parse_and_eval("$ss")) != "<unavailable>":
    ...
    sys.stdout.write("[0x----:")
sys.stdout.write("0x%08X]" % gdb.parse_and_eval("$esp"))
			end
        end
    end
        color $COLOR_SEPARATOR
