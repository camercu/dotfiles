...
```
<type>[optinoal scope]: <description>
...
Add scopes if it is possible to easily add context with one.
...
Exception: pre-1.0.0, all breaking changes just cause a minor version bump. (0.1.0
-> 0.2.0)
